...
{   ENDFILE,ERROR,
    ...
    ID,NUM,
    /* special symbols */
    ASSIGN,EQ,NE,LT,LE,GT,GE,PLUS,MINUS,TIMES,OVER,LPAREN,RPAREN,LBRACE,RBRACE,LSBRACKET,RSBRACKET,SEMI,COMMA
} TokenType;
...
{   struct treeNode * child[MAXCHILDREN];
    ...
    union {
        ...
        int val;
        char * name; } attr;
    TokenType  type; /* for type checking of exps */
} TreeNode;
