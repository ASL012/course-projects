...
typedef enum
{ START,INNUM,INID,INEQ,INLT,INGT,INNE,INDIV,INCOMMENT,ENDCOMMENT,DONE }
        StateType;
...
/* getNextChar fetches the next non-blank character from lineBuf, reading in a new line if lineBuf is exhausted */
